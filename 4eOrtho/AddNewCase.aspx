...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:UpdatePanel ID="upAddNewCase" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <div class="main_right_cont minheigh" style="width: 100%;">
                ...
                <div class="widecolumn" id="widget">
                    ...
                    <fieldset>
                        ...
                        <div class="clear"></div>
                        <div class="parsonal_textfild alignleft" id="divConnectPatient" style="display: none;">
                            <label>
                                &nbsp;
                            </label>
                            <small>
                                <strong>Selected patient is from 4eDental Connect.</strong>
                            </small>
                        </div>
                        <div class="parsonal_textfild alignleft">
                            <label>
                    ...
                    <fieldset>
                        <div class="wdt alignleft" id="select_package">
                            <asp:PlaceHolder ID="phSelectPackage" runat="server">
                                <div class="parsonal_textfild alignleft">
                                    ...
                                    <div class="parsonal_select">
                                        <asp:DropDownList ID="ddlPackage" runat="server" TabIndex="16" AutoPostBack="true" onchange="ddlPackageChange(this)" meta:resourcekey="ddlPackageResource1">
                                        </asp:DropDownList>
                        ...
                        <div class="wdt alignleft" id="add_stage" style="display: none;">
                            <%--<asp:PlaceHolder ID="PlaceHolder1" runat="server">--%>
                            <div class="parsonal_textfild alignleft">
                                <label>
                                    <asp:Label ID="lblStage" runat="server" Text="Select Stage"></asp:Label>
                                    <span class="alignright">:<span class="asteriskclass">&nbsp;</span></span>
                                </label>
                                <asp:TextBox ID="txtStageName" runat="server"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ForeColor="Red" runat="server" SetFocusOnError="True"
                                    ControlToValidate="txtStageName" Display="None" ErrorMessage="Please enter Stage Name."
                                    CssClass="errormsg" ValidationGroup="validation4" />
                                <asp:DropDownList ID="ddlStageAdd" runat="server" AutoPostBack="true" onchange="ddlAddStage(this)" Style="display: none;">
                            ...
                            <div class="parsonal_textfild alignleft">
                                <label>
                                    <asp:Label ID="lblStageDescription" runat="server" Text="Description"></asp:Label>
                                </label>
                                <asp:TextBox ID="txtStageDescription" TextMode="MultiLine" Rows="3" ClientIDMode="Static" runat="server"></asp:TextBox>
                            </div>

                            <div class="parsonal_textfild alignleft">
                                <label>
                                    <asp:Label ID="lblStageCharges" runat="server" Text="Charges ($)"></asp:Label>
                                </label>
                                <asp:TextBox ID="txtStageCharges" ClientIDMode="Static" CssClass="amount" Enabled="false" ReadOnly="true" runat="server" MaxLength="15" Style="text-align: left; min-width: 100px;"></asp:TextBox>
                            </div>
                            ...
                            <div class="parsonal_textfild alignleft">
                                ...
                                <div class="radio-selection">
                                    <asp:RadioButton ID="rbtnPaymentByPatient" Text="Patient" runat="server" GroupName="PaymentBy" Checked="True" />
                                    <asp:RadioButton ID="rbtnPaymentByDoctor" Text="Doctor" runat="server" GroupName="PaymentBy" />
                                </div>
                            </div>

                            <div class="blue_btn_small alignleft">
                                <label>
                                </label>
                            ...
                            <div class="date2">
                                ...
                                <fieldset id="Fieldset1" runat="server" style="width: 535px;">
                                    <legend>Stage Details</legend>
                                    <table id="tblStageList" runat="server" class="grid_table" cellpadding="0" cellspacing="0" width="100%">
                                        <tr>
                                            <td>
                                                <div class="topadd_f flex">
                                                    <span class="one">
                                        ...
                                        <tr>
                                            <td colspan="4" style="text-align: center;">
                                                <div class="grenchk dark" id="flex">
                                                    <div class="whitetext">
                                                        <asp:Label ID="lblNoDataFound" runat="server" CssClass="errMsg" Text="No Data Found">
                                                        </asp:Label>
                                                    </div>
                                                </div>
                                            </td>
                                    ...
                                    <asp:Repeater ID="rptStageList" runat="server" Visible="false">
                                        <HeaderTemplate>
                                            <table id="tblrptStageList" class="grid_table" cellpadding="0" cellspacing="0" width="100%">
                                                <tr>
                                                    <td>
                                                        <div class="topadd_f flex">
                                                            <span class="one">
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                <td>
                                                    <div class="grenchk dark" id="flex">
                                                        <div class="whitetext" title="<%# Eval("StageDescription")%>">
                                                            Stage&nbsp;<%# Eval("StageNo")%>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="grenchk dark" id="flex">
                                                        <div class="whitetext">
                                                            <%# GetStageStatus(Convert.ToString(Eval("Status"))) %>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
        ...
        <Triggers>
            <asp:AsyncPostBackTrigger ControlID="btnAddStage" EventName="Click" />
        </Triggers>
    </asp:UpdatePanel>
    <asp:Button ID="btnAddStage" runat="server" OnClick="btnAddStage_Click" Text="Add Stage" Style="display: none;" />
    ...
    <asp:HiddenField ID="hdnIsConnectPatient" runat="server" ClientIDMode="Static" Value="0" />
        ...
        function CreateWizard() {
            ...
            form.steps({
                ...
                onStepChanged: function (event, currentIndex, newIndex) {
                    var isConnectUser = $('#hdnIsConnectPatient').val() == "1" ? true : false;;
                    ...
                    switch (currentIndex) {
                        ...
                        case 2:
                            if (isConnectUser)
                                $("#widget").find(".actions a:eq(1)").text('Manage Stage');
                            else
            ...
            $.ajax({
                ...
                success: function (msg) {
                    if (msg.d != null) {
                        ...
                        if (msg.d.IsConnectUser == true) {
                            $('#divConnectPatient').show();
                            $('#hdnIsConnectPatient').val(1);
                            $('#select_package').hide();
                            $('#add_stage').show();
                            $('[id$=lblHeaderSelectPackage]').text('Manage Stage');
                        }
                        else {
                            $('#divConnectPatient').hide();
                            $('#hdnIsConnectPatient').val(0);
                            $('#tablist').find('li.current a').trigger('click');
                            $('#widget-t-3').show();
                            $('#select_package').show();
                            $('#add_stage').hide();
                            $('[id$=lblHeaderSelectPackage]').text('Select Package');
                        }
                    }
                    else {
                        $('[id$=txtFirstName]').val("");
