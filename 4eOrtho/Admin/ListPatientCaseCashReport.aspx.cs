...
{
    public partial class ListPatientCaseCashReport : System.Web.UI.Page
    {
        #region Declaration
        int totalRecordsCount;
        private ILog logger = log4net.LogManager.GetLogger(typeof(ListPatientCaseCashReport));
        #endregion
        ...
        /// <returns></returns>
        public List<GetAllCashPaymentRecoredForPatientCase_Result> GetPatientCaseCashReport(string sortField, string sortDirection, int pageSize, int startRowIndex, string searchField, string searchText, Nullable<DateTime> startdate, Nullable<DateTime> enddate)
        {
            try
            {
                ...
                List<GetAllCashPaymentRecoredForPatientCase_Result> lstAllCashPaymentRecoredForPatientCase = paymentSuccessEntity.GetAllCashPaymentRecoredForPatientCase(sortField, sortDirection, pageSize, pageIndex, searchText, startdate, enddate, out totalRecords);
