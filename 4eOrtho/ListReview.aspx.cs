...
namespace _4eOrtho
{
    public partial class ListReview : PageBase
    {
        #region Declaration
        ...
        protected void odsReview_Selecting(object sender, ObjectDataSourceSelectingEventArgs e)
        {
            try
            {
                ...
                if (currentSession != null)
                {
                    ...
                    e.InputParameters["userType"] = currentSession.UserType;
        ...
        protected void Custom_Command(object sender, CommandEventArgs e)
        {
            try
            {
                ...
                {
                    PageRedirect("~/EditDoctorReview.aspx?reviewId=" + e.CommandArgument.ToString());
                }
            }
            catch (System.Threading.ThreadAbortException)
            {
        ...
        private void SetSortImage()
        {
            try
            {
                (lvReview.FindControl("lnkSortPatient") as LinkButton).Attributes.Add("class", "");
                ...
                if (ViewState["SortBy"] != null)
                {
                    ...
                    {
                        case "patientname":
                            lnkSortedColumn = lvReview.FindControl("lnkSortPatient") as LinkButton;
                            break;
                    }
                }
