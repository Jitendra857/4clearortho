<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PatientLogin.aspx.cs" Inherits="_4eOrtho.PatientLogin" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" %>

<!DOCTYPE html>
<html lang="en">
<head id="Head1" runat="server">
    <meta charset="utf-8">
    <title>4ClearOrtho - Patient Login</title>
                    ...
                    <div class="patientlogin_main">
                        <div class="middlesection">
                            <div class="doctorlogin">
                                <h2><%= this.GetLocalResourceObject("PatientLogin") %>
                                </h2>
                            </div>
                                        ...
                                        <td>
                                            <div class="forgot_text_doctor" style="padding-right: 25px">
                                                <div class="date_cont_right marginlf">
                                                    <a href="ForgotPassword.aspx?patient=p" id="lbtnForgotPassword" title='<%= this.GetLocalResourceObject("ForgotPassword") %>'><%= this.GetLocalResourceObject("ForgotPassword") %></a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
