...
AjaxControlToolkit.ValidatorCalloutBehavior = function AjaxControlToolkit$ValidatorCalloutBehavior(element) {
    ...
    this._elementToValidateClone = null;
...
AjaxControlToolkit.ValidatorCalloutBehavior.prototype = {
    initialize : function() {
        ...
        this._elementToValidateClone = this.cloneObject(this._elementToValidate);
    },
    ...
    show : function(force) {        
        if (force || !this._isOpen) {
            ...
            this.get_element().parentNode.appendChild(this._popupTable)
            this._popupBehavior._parentElement = this._elementToValidate;  
    ...
    hide : function() {
        ...
        if (this._isOpen || $common.getVisible(this._popupTable)) {
            this.get_element().parentNode.removeChild(this._popupTable)
    ...
    _onvalidate : function(val) {
        this._elementToValidate = document.getElementById(this._elementToValidate.id);
        if (typeof(this._elementToValidate.Validators) == "undefined"){
            this._focusAttached = false;
            for (var obj in this._elementToValidateClone.Validators) {
                ValidatorHookupControl(this._elementToValidate,document.getElementById( this._elementToValidateClone.Validators[obj].id));
            }
        }  
        try {
            $removeHandler(this._elementToValidate, "focus", this._focusHandler);
