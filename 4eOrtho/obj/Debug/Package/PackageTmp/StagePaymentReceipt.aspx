<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/OrthoInnerMaster.Master" CodeBehind="StagePaymentReceipt.aspx.cs" Inherits="_4eOrtho.StagePaymentReceipt" %>
...
<div id="container" class="cf" >
    ...
    <asp:Button ID="btnBack" CssClass="btnback" runat="server" Text="Back" PostBackUrl="PatientStageDetails.aspx"  TabIndex="7" meta:resourcekey="btnBackResource1" />
                </div>
        ...
        <button type="button" onclick="javascript: printDiv('printablediv')" class="btn btn-primary btn-lg btn-block">
                    Print  <img src="Content/images/printwhite.png" />   <%--<span class="glyphicon glyphicon-chevron-right"></span>--%>
                </button>
