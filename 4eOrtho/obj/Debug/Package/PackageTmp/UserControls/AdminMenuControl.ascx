        ...
        <li class="none">
            ...
            <ul>
                ...
                <li>
                 ...
                 <li>
                    <asp:HyperLink ID="hypaymentreportDetails" runat="server" Text="Patient / Payment Report"
                        NavigateUrl="~/Admin/PatientStagePaymentReport.aspx" meta:resourcekey="hypNewCaseDetailsResource12"></asp:HyperLink>
                </li>
                <%--<li>
        ...
        <li id="liSetup" runat="server">
            ...
            <ul>
                ...
                <li>
                 ...
                 <li>
                    <asp:HyperLink ID="HyperLink3" runat="server" Text="Stage Master" NavigateUrl="~/Admin/PatientStageList.aspx" >Patient Stage Details</asp:HyperLink>
                </li>
                <li>
