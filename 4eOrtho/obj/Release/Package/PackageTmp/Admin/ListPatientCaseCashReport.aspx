<%@ Page Title="Patient Case Charge Report" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ListPatientCaseCashReport.aspx.cs" Inherits="_4eOrtho.Admin.ListPatientCaseCashReport" EnableViewState="true" %>
        ...
        <ContentTemplate>
            <div id="container" class="cf">
                <div class="page_title">
                    <h2 class="padd">
                        <asp:Label ID="lblHeader" Text="Patient Case Cash Report" runat="server"></asp:Label></h2>
                                ...
                                <tr>
                                    <td align="left" valign="top" class="rgt">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left" valign="middle" class="equip" width="15%">
                                                            <asp:LinkButton ID="lnkEmail" runat="server" CommandName="CustomSort" OnCommand="Custom_Command"
                                                                CommandArgument="Email" Text="Patient Email"></asp:LinkButton>
                                                        </td>
                                                        <td align="left" valign="middle" class="equip" width="15%">
                                                            <asp:Label ID="lblCaseNo" runat="server" Text="CaseNo"></asp:Label>
                                                        </td>
                                            ...
                                            <EmptyDataTemplate>
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        ...
                                                        <td align="left" valign="middle" class="equip" width="20%">
                                                            <asp:Label ID="lblEmail" runat="server" Text="Patient Email"></asp:Label>
                                                        </td>
                                                        ...
                                                        <td align="left" valign="middle" class="equip" width="10%">
                                                            <asp:Label ID="lblStatus" runat="server" Text="Payment Status"></asp:Label>
                                                        </td>
                                                        <td align="left" valign="middle" class="equip" width="10%">
                                        ...
                                        <asp:ObjectDataSource ID="odsPatientCaseCashReport" runat="server" SelectMethod="GetPatientCaseCashReport"
                                            ...
                                            TypeName="_4eOrtho.Admin.ListPatientCaseCashReport" OnSelecting="odsPatientCaseCashReport_Selecting"></asp:ObjectDataSource>
                                    </td>
                                </tr>
                            </table>
                        </div>
